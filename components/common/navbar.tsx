    ...
    <div className="fixed top-0 left-0 right-0 z-50 backdrop-blur-md">
      <div className="flex justify-center pt-4 lg:pt-10">
        <motion.header
          ...
          className="border-app-border from-app-navbar-bg-start to-app-navbar-bg-end flex h-16 w-[95%] items-center justify-between rounded-3xl border bg-linear-to-b px-6 shadow-md lg:w-[97%]"
        >
          <Link
